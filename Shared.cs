...
namespace PayJS_Samples.Misc
{
    public static class Shared
    {
       ...
       // public static string ClientID = "YTO99XLnZo6rL6aAPq4lPHxyyJBQwHCA";

        public static string Environment = "cert";
        public static string PostbackUrl = "https://requestb.in"; // https://requestb.in is great for playing with this
